...
const TopNavbar: React.FC<TopNavbarProps> = ({
    ...
    return (
        <div className="sticky top-0 z-50 h-16 bg-gray-800 border-b border-gray-700 flex items-center justify-between px-6">
            {/* Far Left - Logo */}
            <button 
                onClick={() => {
            ...
            {/* Far Right - System Active + Wallet Connection */}
